            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <p className="home-about-body">
                 Hi, my name is <span className="yellow">Prakhar Katiyar</span>
                 and I'm from <span className="yellow"> Kanpur, Uttar Pradesh.</span>
                <br />
                <br />
                Currently I'm persuing Master Of Computer Application From Lovely Professional University. Phagwara,Punjab
                <br />
                <br />
                  As a
                  ...
                  <br />I am proficient in
                    <b className="yellow"> html,css,Javascript,Reactjs </b>
